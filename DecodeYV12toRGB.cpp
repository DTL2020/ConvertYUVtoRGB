		...
		if (cpuFlags & CPUF_AVX2) // use AVX2
		{
			...
			/*				int row_proc_size;
							if (cs == 1) // 8bit
								...
								row_proc_size = (row_size_Y / 2);
								*/
			const __m256i ymm_dw_cbias = _mm256_set1_epi32(128);

			const __m256i ymm_dwKr = _mm256_set1_epi32(Kr);
			const __m256i ymm_dwKb = _mm256_set1_epi32(Kb);

			const __m256i ymm_dwKgu = _mm256_set1_epi32(Kgu);
			const __m256i ymm_dwKgv = _mm256_set1_epi32(Kgv);
...
/*				if (cs == 2)
				...
				*/
				...
				const __m256i ymm_RGBgain = _mm256_set1_epi32(RGBg);
